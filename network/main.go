// Package network contains functions that deal with dfc network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/dfc/go/hash"
	"github.com/dfc/go/support/errors"
	"github.com/dfc/go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public dfc network
...
// resulting hash is the value that can be signed by dfc secret key to
// authorize the transaction identified by the hash to dfc validators.
