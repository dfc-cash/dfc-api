...
- network:  Added the `HashTransaction` helper func to get the hash of a transaction targeted to a specific dfc network.
...
[Unreleased]: https://github.com/dfc/go/commits/master