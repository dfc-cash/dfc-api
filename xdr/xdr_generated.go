...
// LedgerScpMdfcges is an XDR Struct defines as:
//
//   struct LedgerSCPMdfcges
//    {
//        uint32 ledgerSeq;
//        SCPEnvelope mdfcges<>;
//    };
//
type LedgerScpMdfcges struct {
	LedgerSeq Uint32
	Mdfcges  []ScpEnvelope
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s LedgerScpMdfcges) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *LedgerScpMdfcges) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*LedgerScpMdfcges)(nil)
	_ encoding.BinaryUnmarshaler = (*LedgerScpMdfcges)(nil)
)
...
//    {
//        SCPQuorumSet quorumSets<>; // additional quorum sets used by ledgerMdfcges
//        LedgerSCPMdfcges ledgerMdfcges;
//    };
//
type ScpHistoryEntryV0 struct {
	QuorumSets     []ScpQuorumSet
	LedgerMdfcges LedgerScpMdfcges
}
...
// MdfcgeType is an XDR Enum defines as:
//
//   enum MdfcgeType
//    {
//        ERROR_MSG = 0,
...
//    };
//
type MdfcgeType int32

const (
	MdfcgeTypeErrorMsg        MdfcgeType = 0
	MdfcgeTypeAuth            MdfcgeType = 2
	MdfcgeTypeDontHave        MdfcgeType = 3
	MdfcgeTypeGetPeers        MdfcgeType = 4
	MdfcgeTypePeers           MdfcgeType = 5
	MdfcgeTypeGetTxSet        MdfcgeType = 6
	MdfcgeTypeTxSet           MdfcgeType = 7
	MdfcgeTypeTransaction     MdfcgeType = 8
	MdfcgeTypeGetScpQuorumset MdfcgeType = 9
	MdfcgeTypeScpQuorumset    MdfcgeType = 10
	MdfcgeTypeScpMdfcge      MdfcgeType = 11
	MdfcgeTypeGetScpState     MdfcgeType = 12
	MdfcgeTypeHello           MdfcgeType = 13
)

var mdfcgeTypeMap = map[int32]string{
	0:  "MdfcgeTypeErrorMsg",
	2:  "MdfcgeTypeAuth",
	3:  "MdfcgeTypeDontHave",
	4:  "MdfcgeTypeGetPeers",
	5:  "MdfcgeTypePeers",
	6:  "MdfcgeTypeGetTxSet",
	7:  "MdfcgeTypeTxSet",
	8:  "MdfcgeTypeTransaction",
	9:  "MdfcgeTypeGetScpQuorumset",
	10: "MdfcgeTypeScpQuorumset",
	11: "MdfcgeTypeScpMdfcge",
	12: "MdfcgeTypeGetScpState",
	13: "MdfcgeTypeHello",
}

// ValidEnum validates a proposed value for this enum.  Implements
// the Enum interface for MdfcgeType
func (e MdfcgeType) ValidEnum(v int32) bool {
	_, ok := mdfcgeTypeMap[v]
	return ok
}

// String returns the name of `e`
func (e MdfcgeType) String() string {
	name, _ := mdfcgeTypeMap[int32(e)]
	return name
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s MdfcgeType) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *MdfcgeType) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*MdfcgeType)(nil)
	_ encoding.BinaryUnmarshaler = (*MdfcgeType)(nil)
)
...
// StellarMdfcge is an XDR Union defines as:
//
//   union StellarMdfcge switch (MdfcgeType type)
//    {
//    case ERROR_MSG:
//        Error error;
//    case HELLO:
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u StellarMdfcge) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of StellarMdfcge
func (u StellarMdfcge) ArmForSwitch(sw int32) (string, bool) {
	switch MdfcgeType(sw) {
	case MdfcgeTypeErrorMsg:
		return "Error", true
	case MdfcgeTypeHello:
		return "Hello", true
	case MdfcgeTypeAuth:
		return "Auth", true
	case MdfcgeTypeDontHave:
		return "DontHave", true
	case MdfcgeTypeGetPeers:
		return "", true
	case MdfcgeTypePeers:
		return "Peers", true
	case MdfcgeTypeGetTxSet:
		return "TxSetHash", true
	case MdfcgeTypeTxSet:
		return "TxSet", true
	case MdfcgeTypeTransaction:
		return "Transaction", true
	case MdfcgeTypeGetScpQuorumset:
		return "QSetHash", true
	case MdfcgeTypeScpQuorumset:
		return "QSet", true
	case MdfcgeTypeScpMdfcge:
		return "Envelope", true
	case MdfcgeTypeGetScpState:
		return "GetScpLedgerSeq", true
	}
	return "-", false
}

// NewStellarMdfcge creates a new  StellarMdfcge.
func NewStellarMdfcge(aType MdfcgeType, value interface{}) (result StellarMdfcge, err error) {
	result.Type = aType
	switch MdfcgeType(aType) {
	case MdfcgeTypeErrorMsg:
		tv, ok := value.(Error)
		if !ok {
...
// panicing if the value is not set.
func (u StellarMdfcge) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u StellarMdfcge) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u StellarMdfcge) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s StellarMdfcge) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *StellarMdfcge) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*StellarMdfcge)(nil)
	_ encoding.BinaryUnmarshaler = (*StellarMdfcge)(nil)
)

// AuthenticatedMdfcgeV0 is an XDR NestedStruct defines as:
//
//   struct
//    {
//       uint64 sequence;
//       StellarMdfcge mdfcge;
//       HmacSha256Mac mac;
//        }
//
type AuthenticatedMdfcgeV0 struct {
	Sequence Uint64
	Mdfcge  StellarMdfcge
	Mac      HmacSha256Mac
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s AuthenticatedMdfcgeV0) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AuthenticatedMdfcgeV0) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AuthenticatedMdfcgeV0)(nil)
	_ encoding.BinaryUnmarshaler = (*AuthenticatedMdfcgeV0)(nil)
)

// AuthenticatedMdfcge is an XDR Union defines as:
//
//   union AuthenticatedMdfcge switch (uint32 v)
//    {
//    case 0:
//        struct
//    {
...
//    };
//
type AuthenticatedMdfcge struct {
	V  Uint32
	V0 *AuthenticatedMdfcgeV0
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u AuthenticatedMdfcge) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of AuthenticatedMdfcge
func (u AuthenticatedMdfcge) ArmForSwitch(sw int32) (string, bool) {
	switch Uint32(sw) {
	case 0:
		return "V0", true
	}
...
// NewAuthenticatedMdfcge creates a new  AuthenticatedMdfcge.
func NewAuthenticatedMdfcge(v Uint32, value interface{}) (result AuthenticatedMdfcge, err error) {
	result.V = v
	switch Uint32(v) {
	case 0:
		tv, ok := value.(AuthenticatedMdfcgeV0)
		if !ok {
			err = fmt.Errorf("invalid value, must be AuthenticatedMdfcgeV0")
			return
		}
		result.V0 = &tv
	}
...
// MustV0 retrieves the V0 value from the union,
// panicing if the value is not set.
func (u AuthenticatedMdfcge) MustV0() AuthenticatedMdfcgeV0 {
	val, ok := u.GetV0()
...
// GetV0 retrieves the V0 value from the union,
// returning ok if the union's switch indicated the value is valid.
func (u AuthenticatedMdfcge) GetV0() (result AuthenticatedMdfcgeV0, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.V))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s AuthenticatedMdfcge) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AuthenticatedMdfcge) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AuthenticatedMdfcge)(nil)
	_ encoding.BinaryUnmarshaler = (*AuthenticatedMdfcge)(nil)
)
