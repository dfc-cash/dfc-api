...
// the format used internally to dfc-core.
//
// dfc-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, horizon, the client-libraries and other built
// on top of dfc-core use a convention, encoding amounts as a string of
...
// represented in dfc-core as 1010010000.
package amount
...
// Parse parses the provided as a dfc "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a dfc "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to dfc
