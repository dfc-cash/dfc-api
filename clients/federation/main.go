...
var DefaultTestNetClient = &Client{
	...
	StellarTOML: dfctoml.DefaultClient,
}
...
// dfc.toml file.  The response is used to find the federation server that a
// query should be made against.
type StellarTOML interface {
	GetStellarToml(domain string) (*dfctoml.Response, error)
}

// confirm interface conformity
var _ StellarTOML = dfctoml.DefaultClient
