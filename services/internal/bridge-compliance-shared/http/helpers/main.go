...
var (
	...
	InternalServerError = &ErrorResponse{Code: "internal_server_error", Mdfcge: "Internal Server Error, please try again.", Status: http.StatusInternalServerError}
	// InvalidParameterError is an error response
	InvalidParameterError = &ErrorResponse{Code: "invalid_parameter", Mdfcge: "Invalid parameter.", Status: http.StatusBadRequest}

	// missingParameterError is an error response
	missingParameterError = &ErrorResponse{Code: "missing_parameter", Mdfcge: "Required parameter is missing.", Status: http.StatusBadRequest}
)
...
type ErrorResponse struct {
	...
	// Error mdfcge that will be returned to API consumer
	Mdfcge string `json:"mdfcge"`
