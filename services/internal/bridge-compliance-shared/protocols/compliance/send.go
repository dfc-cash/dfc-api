...
import (
	...
	"github.com/dfc/go/protocols/compliance"
...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,dfc_accountid"`
	// Sender address (like alice*dfc.org)
	Sender string `form:"sender" valid:"required,dfc_address"`
	// Destination address (like bob*dfc.org)
	Destination string `form:"destination" valid:"required,dfc_address"`
	// ForwardDestination
