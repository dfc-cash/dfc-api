...
type Database interface {
	...
	CreateAddressAssociation(chain Chain, dfcAddress, address string, addressIndex uint32) error
	...
	// Should return nil if not found.
	GetAssociationByStellarPublicKey(dfcPublicKey string) (*AddressAssociation, error)
