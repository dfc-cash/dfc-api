...
import (
	...
	tdb "github.com/dfc/go/services/horizon/internal/test/db"
...
// StellarCoreDatabase returns a connection to the dfc core test database
//
...
// use when connecting to the dfc-core database
//
