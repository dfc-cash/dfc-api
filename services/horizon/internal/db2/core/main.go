...
// Offer is row of data from the `offers` table from dfc-core
type Offer struct {
...
// internalOffer is row of data from the `offers` table from dfc-core used
...
// Q is a helper struct on which to hang common queries against a dfc
// core database.
type Q struct {
	*db.Session
}
...
// Signer is a row of data from the `signers` table from dfc-core
type Signer struct {
	Accountid string
	Publickey string
	Weight    int32
...
// Transaction is row of data from the `txhistory` table from dfc-core
...
// TransactionFee is row of data from the `txfeehistory` table from dfc-core
...
// Trustline is a row of data from the `trustlines` table from dfc-core
...
// dfc-core database this ingestion system is communicating with.  Horizon,
