...
import (
	...
	results "github.com/dfc/go/services/horizon/internal/txsub/results/db"
	"github.com/dfc/go/services/horizon/internal/txsub/sequence"
...
func initIngester(app *App) {
	...
	if app.config.NetworkPassphrase == "" {
		log.Fatal("Cannot start ingestion without network passphrase. Please confirm connectivity with dfc-core.")
	}
...
func initDbMetrics(app *App) {
	...
	app.metrics.Register("dfc_core.latest_ledger", app.coreLatestLedgerGauge)
	app.metrics.Register("history.open_connections", app.horizonConnGauge)
	app.metrics.Register("dfc_core.open_connections", app.coreConnGauge)
