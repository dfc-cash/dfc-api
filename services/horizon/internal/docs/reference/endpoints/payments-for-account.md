...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=payments&endpoint=for_account
---
...
curl "https://horizon-testnet.dfc.org/accounts/GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ/payments?limit=25&order=desc"
```
