...
title: All Payments
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=payments&endpoint=all
---
...
curl "https://horizon-testnet.dfc.org/payments?limit=200"
```

```bash
# Retrieve a page of payments to occur immediately before the transaction
# specified by the paging token "1234".
curl "https://horizon-testnet.dfc.org/payments?cursor=1234&order=desc"
```
