...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=transactions&endpoint=for_ledger
---
...
```sh
curl "https://horizon-testnet.dfc.org/ledgers/69859/transactions"
```
