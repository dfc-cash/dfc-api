...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=effects&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.dfc.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/effects"
```
