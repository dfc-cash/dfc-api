...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=order_book&endpoint=details
---
...
```sh
curl "https://horizon-testnet.dfc.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=FOO&buying_asset_issuer=GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG&limit=20"
```
