...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=trades&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.dfc.org/accounts/GBYTR4MC5JAX4ALGUBJD7EIKZVM7CUGWKXIUJMRSMK573XH2O7VAK3SR/trades?limit=1"
```
