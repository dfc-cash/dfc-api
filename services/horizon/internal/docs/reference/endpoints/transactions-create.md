...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=transactions&endpoint=create
---
...
process](https://www.dfc.org/developers/learn/concepts/transactions.html#life-cycle).
...
Information about [building transactions](https://www.dfc.org/developers/js-dfc-base/learn/building-transactions.html) in JavaScript.
...
curl -X POST \
  ...
  "https://horizon-testnet.dfc.org/transactions"
```
