...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=transactions&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.dfc.org/accounts/GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ/transactions?limit=1"
```
