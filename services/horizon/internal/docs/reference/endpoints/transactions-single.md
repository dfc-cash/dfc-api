...
clientData:
  laboratoryUrl: https://www.dfc.org/laboratory/#explorer?resource=transactions&endpoint=single
---
...
```sh
curl "https://horizon-testnet.dfc.org/transactions/6391dd190f15f7d1665ba53c63842e368f485651a53d8d852ed442a446d1c69a"
```
