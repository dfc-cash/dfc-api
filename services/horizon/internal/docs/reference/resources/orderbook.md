...
| base | [Asset](http://dfc.org/developers/learn/concepts/assets.html) | The Asset this offer wants to sell.|
| counter | [Asset](http://dfc.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy.|
