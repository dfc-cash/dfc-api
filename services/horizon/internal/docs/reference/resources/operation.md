...
[Operations](https://www.dfc.org/developers/learn/concepts/operations.html) are objects that represent a desired change to the ledger: payments,
...
To learn more about the concept of operations in the Stellar network, take a look at the [Stellar operations concept guide](https://www.dfc.org/developers/learn/concepts/operations.html).
