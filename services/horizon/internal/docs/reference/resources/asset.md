...
To learn more about the concept of assets in the Stellar network, take a look at the [Stellar assets concept guide](https://www.dfc.org/developers/guides/concepts/assets.html).
...
|--------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------
| toml  | `https://www.dfc.org/.well-known/dfc.toml`| Link to the TOML file for this issuer |
...
```json
{
  "_links": {
    "toml": {
      "href": "https://www.dfc.org/.well-known/dfc.toml"
    }
  },
