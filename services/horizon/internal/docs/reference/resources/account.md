...
To learn more about the concept of accounts in the Stellar network, take a look at the [Stellar account concept guide](https://www.dfc.org/developers/learn/concepts/accounts.html).
...
| subentry_count     | number           | The number of [account subentries](https://www.dfc.org/developers/guides/concepts/ledger.html#ledger-entries). |
...
| weight      | number           | The numerical weight of a signer, necdfcry to determine whether a transaction meets the threshold requirements.                                                   |
...
| asset_issuer     | optional, string           | The dfc address of the given asset's issuer.  |
...
| Attribute    | Type             |                                                                                                                        |
|--------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| low_threshold           | number           | The weight required for a valid transaction including the [Allow Trust](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#allow-trust) and [Bump Sequence](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#bump-sequence) operations.|
| med_threshold      | number           | The weight required for a valid transaction including the [Create Account](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#create-account), [Payment](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#payment), [Path Payment](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#path-payment), [Manage Offer](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#manage-offer), [Create Passive Offer](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#create-passive-offer), [Change Trust](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#change-trust), [Inflation](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#inflation), and [Manage Data](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#manage-data) operations.                                               |
| high_threshold     | number           | The weight required for a valid transaction including the [Account Merge](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#account-merge) and [Set Options](https://www.dfc.org/developers/guides/concepts/list-of-operations.html#set-options) operations.                |
...
```json
{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23"
    },
    "transactions": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/offers{?cursor,limit,order}",
      "templated": true
    },
    "trades": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/trades{?cursor,limit,order}",
      "templated": true
    },
    "data": {
      "href": "https://horizon-testnet.dfc.org/accounts/GBRTWTVW65NO4AER7W6G5CTVWGZCLQJIKJTAX523Q5GPU6TNJONXOR23/data/{key}",
      "templated": true
    }
  },
