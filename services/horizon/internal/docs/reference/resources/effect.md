...
represent specific changes that occur in the ledger, but are not necdfcrily
directly reflected in the [ledger](https://www.dfc.org/developers/learn/concepts/ledger.html) or [history](https://github.com/dfc/dfc-core/blob/master/docs/history.md), as [transactions](https://www.dfc.org/developers/learn/concepts/transactions.html) and [operations](https://www.dfc.org/developers/learn/concepts/operations.html) are.
