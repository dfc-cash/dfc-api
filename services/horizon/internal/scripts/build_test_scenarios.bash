...
GOTOP="$( cd "$DIR/../../../../../../../.." && pwd )"
PACKAGES=$(find $GOTOP/src/github.com/dfc/go/services/horizon/internal/test/scenarios -iname '*.rb' -not -name '_common_accounts.rb')
#PACKAGES=$(find $GOTOP/src/github.com/dfc/go/services/horizon/internal/test/scenarios -iname 'failed_transactions.rb')

go install github.com/dfc/go/services/horizon

dropdb hayashi_scenarios --if-exists
createdb hayashi_scenarios

export DFC_CORE_DATABASE_URL="postgres://localhost/hayashi_scenarios?sslmode=disable"
export DATABASE_URL="postgres://localhost/horizon_scenarios?sslmode=disable"
export NETWORK_PASSPHRASE="Test SDF Network ; September 2015"
export DFC_CORE_URL="http://localhost:8080"
...
for i in $PACKAGES; do
  ...
  psql $DFC_CORE_DATABASE_URL < $CORE_SQL
...
go generate github.com/dfc/go/services/horizon/internal/test/scenarios
# go test github.com/dfc/go/services/horizon/internal/ingest
