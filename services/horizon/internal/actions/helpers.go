...
import (
	...
	"github.com/dfc/go/services/horizon/internal/db2"
	...
	"github.com/dfc/go/support/time"
...
// GetAddress retrieves a dfc address.  It confirms the value loaded is a
// valid dfc address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a dfc
...
// the string at the provided name in accordance with the dfc client
// conventions
