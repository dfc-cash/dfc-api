...
import (
	...
	"github.com/dfc/go/services/horizon/internal/hchi"
...
var (
	...
	BeforeHistory = problem.P{
		...
		Detail: "This horizon instance is configured to only track a " +
			"portion of the dfc network's latest history. This request " +
	...
	StaleHistory = problem.P{
		...
		Detail: "This horizon instance is configured to reject client requests " +
			...
			"behind the connected instance of dfc-core.  If you operate this " +
