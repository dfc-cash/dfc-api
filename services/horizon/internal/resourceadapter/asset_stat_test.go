...
import (
	...
	protocol "github.com/dfc/go/protocols/horizon"
	"github.com/dfc/go/services/horizon/internal/db2/assets"
...
func TestLargeAmount(t *testing.T) {
	row := assets.AssetStatsR{
		...
		NumAccounts: 429,
		Flags:       0,
		Toml:        "https://xim.com/.well-known/dfc.toml",
	}
	...
	assert.Equal(t, "https://xim.com/.well-known/dfc.toml", res.Links.Toml.Href)
}
