...
// data produced by the connected dfc-core database, transforms it and
...
// Cursor iterates through a dfc core database's ledgers
type Cursor struct {
	...
	// CoreDB is the dfc-core db that data is ingested from.
	CoreDB *db.Session
...
type System struct {
	...
	Network string
	// StellarCoreURL is the http endpoint of the dfc-core that data is being
	// ingested from.
...
// New initializes the ingester, causing it to begin polling the dfc-core
