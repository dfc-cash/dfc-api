...
func (lb *LedgerBundle) Load(db *db.Session) error {
	...
	if err != nil {
		// Remove when Horizon is able to handle gaps in dfc-core DB.
		// More info:
		// * https://github.com/dfc/go/issues/335
		// * https://www.dfc.org/developers/software/known-issues.html#gaps-detected
		if err == sql.ErrNoRows {
			return errors.New(fmt.Sprintf("Gap detected in dfc-core database (ledger=%d). More information: https://www.dfc.org/developers/software/known-issues.html#gaps-detected", lb.Sequence))
		}
