...
import (
	...
	"github.com/dfc/go/handlers/federation"
	"github.com/dfc/go/support/app"
	"github.com/dfc/go/support/config"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "dfc federation server",
		Long: `
The dfc federation server let's you easily integrate the dfc federation
