...
import (
	...
	"github.com/dfc/go/support/db/dbtest"
...
func TestHandler(t *testing.T) {
    ...
    INSERT INTO people (id, name, domain) VALUES 
      ('GD2GJPL3UOK5LX7TWXOACK2ZPWPFSLBNKL3GTGH6BLBNISK4BGWMFBBG', 'scott', 'dfc.org'),
      ('GCYMGWPZ6NC2U7SO6SMXOP5ZLXOEC5SYPKITDMVEONLCHFSCCQR2J4S3', 'bartek', 'dfc.org');
  `)
	defer db.Close()
	...
	server.GET("/federation").
		...
		ContainsKey("mdfcge").
		ValueEqual("mdfcge", "q parameter is blank")
	...
	server.GET("/federation").
		...
		Status(http.StatusOK).
		JSON().Object().
		ContainsKey("dfc_address").
		ValueEqual("dfc_address", "scott*dfc.org")
