...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"dfc_accountid"`
		NotSTRKey    string `valid:"dfc_accountid"`
		NotAccountID string `valid:"dfc_accountid"`
		Valid        string `valid:"dfc_accountid"`
		WrongType    int    `valid:"dfc_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"dfc_seed"`
		NotSTRKey string `valid:"dfc_seed"`
		NotSeed   string `valid:"dfc_seed"`
		Valid     string `valid:"dfc_seed"`
		WrongType int    `valid:"dfc_seed"`
	}
