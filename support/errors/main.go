...
// New returns an error with the supplied mdfcge. See
// https://godoc.org/github.com/pkg/errors#New for further details
func New(mdfcge string) error {
	return errors.New(mdfcge)
}

// Wrap returns an error annotating err with mdfcge. If err is nil, Wrap
// returns nil.  See https://godoc.org/github.com/pkg/errors#Wrap for more
// details.
func Wrap(err error, mdfcge string) error {
	return errors.Wrap(err, mdfcge)
}
