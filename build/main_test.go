...
func TestBuild(t *testing.T) {
	...
	RunSpecs(t, "Package: github.com/dfc/go/build")
}

// ExampleTransactionBuilder creates and signs a simple transaction, and then
// encodes it into a base64 string capable of being submitted to dfc-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to dfc-core. It uses
...
// being submitted to dfc-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDOTALIMPAM2IV65IOZA7KZL7XWZI5BODFXTRVLIHLQZQCKK57PH5F3H"
	tx, err := Transaction(
		SourceAccount{seed},
