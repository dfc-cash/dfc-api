...
// structures used by the dfc network, most importanly transactions.
//
...
var (
	...
	// to the main public dfc network.
...
// Network establishes the dfc network that a transaction should apply to.
