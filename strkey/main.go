...
const (
	//VersionByteAccountID is the version byte used for encoded dfc addresses
	VersionByteAccountID VersionByte = 3 << 3 // Base32-encodes to 'D...'

	//VersionByteSeed is the version byte used for encoded dfc seed
	VersionByteSeed = 18 << 3 // Base32-encodes to 'S...'

	//VersionByteHashTx is the version byte used for encoded dfc hashTx
	//signer keys.
	VersionByteHashTx = 19 << 3 // Base32-encodes to 'T...'

	//VersionByteHashX is the version byte used for encoded dfc hashX
	//signer keys.
