// Package address provides utility functions for working with dfc
// addresses. See https://www.dfc.org/developers/guides/concepts/federation.
// html#dfc-addresses for more on addresses.
package address
