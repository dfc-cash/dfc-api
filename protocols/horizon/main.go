...
import (
	...
	"github.com/dfc/go/protocols/horizon/base"
...
// I didn't properly mdfcge the community that we were changing the response
...
type Metrics struct {
	...
	CoreLatestLedger       SingleMetric   `json:"dfc_core.latest_ledger"`
	CoreOpenConnections    SingleMetric   `json:"dfc_core.open_connections"`
...
// To do: implement fee suggestions if agreement is reached in https://github.com/dfc/go/issues/926
