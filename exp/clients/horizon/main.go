...
// Client struct contains data for creating an horizon client that connects to the dfc network
type Client struct {
	HorizonURL string
	HTTP       HTTP
}
...
var DefaultTestNetClient = &Client{
	HorizonURL: "https://horizon-testnet.dfc.org",
	HTTP:       http.DefaultClient,
}

// DefaultPublicNetClient is a default client to connect to public network
var DefaultPublicNetClient = &Client{
	HorizonURL: "https://horizon.dfc.org",
	HTTP:       http.DefaultClient,
}
